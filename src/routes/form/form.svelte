<script>
    ...
    async function handleSubmit(event) {
        ...
        formData.append('access_key', import.meta.env.VITE_WEB3FORMS_KEY); // Gebruik de Web3Forms API-sleutel uit .env
        ...
        try {
            ...
            if (result.success) {
                ...
                event.target.reset(); // Reset het formulier na succesvolle indiening
            } else {
                errorMessage = 'Er is iets misgegaan bij het versturen van uw bericht. Probeer het later opnieuw.';
            }
        } catch (error) {
            errorMessage = 'Er is iets misgegaan bij het versturen van uw bericht. Probeer het later opnieuw.';
        } finally {
...
<section class="contact" id="contact">
    ...
    <form on:submit={handleSubmit} class="contact-form">
        <input type="hidden" name="access_key" value={import.meta.env.VITE_WEB3FORMS_KEY}> <!-- Gebruik de Web3Forms API-sleutel uit .env -->
